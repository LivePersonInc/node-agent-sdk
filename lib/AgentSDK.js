...
class SDK extends Events {
    ...
    _registerRequests(arr) {
        ...
        arr.forEach(reqType => {
            ...
            this[key] = (body, headers, metadata, encodedMetadata, messageAudience, callback) => {
                this._createAndSendRequest(reqType, body, headers, metadata, encodedMetadata, messageAudience, callback);
            };
     ...
     * @param {string} [messageAudience] message type ALL/AGENTS_AND_MANAGERS
     ...
     */
    _createAndSendRequest(type, body, headers, metadata, encodedMetadata, messageAudience, callback) {
        if (typeof headers === 'function') {
            callback = headers;
            headers = void 0;
            metadata = void 0;
            encodedMetadata = void 0;
            messageAudience = void 0;
            ...
            encodedMetadata = void 0;
            messageAudience = void 0;
        } else if (typeof messageAudience === 'function') {
            callback = messageAudience;
            metadata = void 0;
            encodedMetadata = void 0;
            messageAudience = void 0;
        }
        ...
        if (Transformer[type]) {
            ...
            ({body, type, headers, metadata, encodedMetadata, messageAudience} = Transformer[type]({
                body,
                type,
                headers,
                metadata,
        ...
        // set the message audience if defined
        if (messageAudience) {
            body.messageAudience = messageAudience;
        }
