...
class SDK extends Events {
    ...
    _handleError(error, context) {
        if (error && context && context.location) {
            switch(context.location) {
                case context.location.startsWith(CONNECTION_TYPES.REFRESH_SESSION):
                    this._handleRefreshSessionError(error);
                    break;
                case context.location.startsWith(CONNECTION_TYPES.CONNECT):
                case context.location.startsWith(CONNECTION_TYPES.RECONNECT):
