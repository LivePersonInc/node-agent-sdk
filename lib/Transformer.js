    ...
    '.ams.aam.ExConversationChangeNotification': (msg, agent) => {
        ...
        msg.body.changes.forEach(change => {
            if (change && change.result) {
                delete change.result.effectiveTTR;
                ...
                delete conversationDetails.dialogs;
                ...
                conversationDetails.__oldParticipants = [];
                conversationDetails.participants.forEach(p => conversationDetails.__oldParticipants.push(p));
