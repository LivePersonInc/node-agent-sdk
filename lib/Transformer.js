...
module.exports = {
    ...
    '.ams.cm.UpdateConversationField': (msg, agent) => {
        if (msg.body.conversationField.field === 'ParticipantsChange') {
            msg.body.conversationField.userId = agent.__oldAgentId;
        }
        return msg;
    },
    ...
    '.ams.routing.RingUpdated': (msg, agent) => {
        delete msg.body; // deprecated notification
        return msg;
    },
    '.ams.routing.RoutingTaskNotification': (msg, agent) => {
        msg.body.changes.forEach(c => {
