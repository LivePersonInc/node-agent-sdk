...
- [Social Messaging Bot](#social-messaging-bot)
...
The social bot is an example SDK implementation in which the bot accepts incoming conversations as the assigned agent. It listens for messages from the consumer and upon receipt marks them as read and responds to the consumer, including [conversation metadata](https://developers.liveperson.com/messaging-agent-sdk-conversation-metadata-guide.html).
